<aside class="user-fixed-sidebar">
    <div class="user-fixed-sidebar__top">
        ...
        <nav class="user-fixed-sidebar__nav">
            ...
            <a class="user-fixed-sidebar__nav-item {{ request()->is('user-complaints') ? 'active' : '' }}" href="/user-complaints">
    <svg class="user-fixed-sidebar__nav-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M21 6h-2V3H5v3H3c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h6v-2H3V8h18v11h-6v2h6c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zM7 5h10v1H7V5zm5 14l5-5h-3v-4h-4v4H7l5 5z"/>
    </svg>
    <span class="user-fixed-sidebar__nav-text">الشكاوى</span>
</a>
